...
class RateLimitFilterTest {
    ...
    void underLimit_shouldProceed() throws Exception {
        ...
        when(request.getRequestURI()).thenReturn("/api/v1/wallets/balance");
    ...
    void rateLimitedResponse_shouldContainJsonBody() throws Exception {
        ...
        when(request.getRequestURI()).thenReturn("/api/v1/limits/test");
        ...
        verify(writer).write(contains("\"path\":\"/api/v1/limits/test\""));
    }
}
