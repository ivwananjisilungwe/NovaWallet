...
/**
 ...
 <p>Endpoints for deposits, withdrawals, transfers, transaction history,
 balance queries, and single transaction lookup. All financial endpoints
 accept an {@code Idempotency-Key} header for duplicate prevention.</p>
 */
@RestController
