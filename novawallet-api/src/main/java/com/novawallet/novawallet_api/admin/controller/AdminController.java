...
/**
 ...
 <p>All endpoints require {@code ADMIN} role. Supports user management,
 wallet freeze/unfreeze, transaction search, audit log viewing,
 fee configuration CRUD, and user deactivation.</p>
 *
 * @see AdminService
 */
@RestController
