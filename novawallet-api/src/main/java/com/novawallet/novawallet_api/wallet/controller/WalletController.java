...
/**
 REST controller for wallet queries and management.

 <p>Provides wallet balance and detail endpoints. Wallet creation is
 handled internally after KYC approval (not via controller).</p>
 */
@RestController
