...
/**
 * Manages wallet lifecycle: creation, status changes (freeze/unfreeze), and queries.
 *
 * <p>Wallets are created after KYC approval with auto-generated account numbers.
 * Freeze/unfreeze operations are audit-logged with the admin's identity.
 * Balance queries are cached via Caffeine with 10-minute write expiry.</p>
 */
@Service
@Transactional
