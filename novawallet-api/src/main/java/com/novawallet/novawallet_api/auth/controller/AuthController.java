 ...
 *
 * <p>Handles user registration, login, token refresh, and logout.
 * All endpoints are unauthenticated (permit-all). Rate limiting is
 * stricter on auth endpoints (10 req/min) to prevent brute-force.</p>
 *
 * @see AuthService
 */
@RestController
