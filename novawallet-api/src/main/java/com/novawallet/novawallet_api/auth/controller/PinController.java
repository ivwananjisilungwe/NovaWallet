...
/**
 * REST controller for transaction PIN management.
 *
 * <p>PINs are 4-6 digit codes required for financial operations. Rate-limited
 * to 3 failed attempts per 15 minutes before lockout.</p>
 */
@RestController
