...
/**
 ...
 <p>Supports forgot-password (sends email with reset link) and
 reset-password (validates token and sets new password). All tokens
 are time-limited and single-use.</p>
 */
@RestController
