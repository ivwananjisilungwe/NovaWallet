...
/** Token-bucket rate limiter: 100 req/min default, 10 for auth. Returns 429. */
@Component
@Profile("!test")
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private boolean isAuthEndpoint(HttpServletRequest request) {
        ...
        return path.contains("/api/v1/auth/") || path.contains("/api/v1/password/")
                || path.contains("/api/v1/pin/") || path.contains("/api/v1/email/");
    }
}
