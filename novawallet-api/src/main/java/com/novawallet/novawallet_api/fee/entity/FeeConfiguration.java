...
/**
 * Maps to the {@code fee_configurations} table. Configurable fee rules per transaction type.
 *
 * <p>Fees are calculated as: {@code totalFee = (amount * percentageFee / 100) + flatFee},
 * clamped by {@code minFee} and {@code maxFee}, rounded to 2 decimal places (HALF_EVEN).
 * Only {@code active = true} configurations are used at runtime.</p>
 */
@Entity
