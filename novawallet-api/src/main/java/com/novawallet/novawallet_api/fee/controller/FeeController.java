...
/**
 REST controller for fee estimation.

 <p>Provides a public endpoint to estimate transaction fees before
 executing a transfer or withdrawal. No authentication required.</p>
 */
@RestController
