 ...
 *
 * <p>Formula: {@code totalFee = (amount * percentageFee / 100) + flatFee},
 * clamped by {@code minFee} / {@code maxFee}, rounded to 2 decimal places
 * using {@code HALF_EVEN} (banker's rounding). Supports CRUD for fee
 * configurations via admin endpoints.</p>
 */
@Service
